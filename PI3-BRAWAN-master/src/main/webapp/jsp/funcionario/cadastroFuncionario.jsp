                        ...
                        <div class="modal-content">
                            ...
                            <form action="${pageContext.request.contextPath}/CadastrarFuncionario" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="rg" placeholder="Digite o RG" id="rg" maxlength="12" OnKeyPress="formatar('##.###.###-#', this)" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <td><input type="text" class="form-control" name="telefone" id="telefone" placeholder="(DDD) XXXXX-XXXX" maxlength="13" OnKeyPress="formatar('##-#####-#####', this)" required></td>
                                </div>
